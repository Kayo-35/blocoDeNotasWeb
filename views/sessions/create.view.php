...
<div class="col-md-3 bg-dark text-light border rounded p-4 mt-5">
    <h3 class="text-center mb-3">Acesse sua Conta</h3>
    ...
    <form method="POST">
        ...
        <div class="d-flex justify-content-center">
            <button type="submit" class="btn btn-outline-success w-100 rounded submit mt-3">Log In</button>
        </div>
    </form>
</div>
</section>
